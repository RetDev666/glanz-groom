              ...
              <div className="pt-4 border-t border-surface-variant">
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="font-sans text-body-sm text-on-surface-variant leading-tight">
                    Ich bin mit den <a href="/terms" target="_blank" className="text-primary hover:underline">Allgemeinen Geschäftsbedingungen</a> einverstanden und bestätige, dass mein Hund keine ansteckenden Krankheiten hat.
                  </span>
                </label>
              </div>
            </div>
