                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={`${theme.bg} flex-1 p-1.5 flex flex-col gap-0.5 overflow-hidden text-gray-800`}>
                            {String(apt.status) === 'blocked' ? (
                              <div className="leading-tight text-[11px] flex-1 flex flex-col items-center justify-center font-medium opacity-80 text-center">
                                <span className="material-symbols-outlined text-[16px] mb-0.5">block</span>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className={`${theme.bg} flex-1 p-1 flex flex-col gap-0.5 overflow-hidden text-gray-800 mb-1`}>
                            {String(apt.status) === 'blocked' ? (
                              <div className="leading-tight text-[10px] flex-1 flex items-center justify-center font-medium opacity-80 text-center">
                                {String(apt.notes || 'Blockiert')}
                              </div>
                            ) : (
                              <>
      ...
      {contextMenu.isOpen && contextMenu.apt && (
        ...
        >
          ...
          >
            ...
            {contextMenu.apt.status === 'blocked' ? (
              <button 
